...
- **Roles for EC2**: Use IAM Roles for applications running on EC2 instead of long-term access keys.
...
- **Service Control Policies (SCPs)**: Use SCPs in AWS Organizations to restrict permissions at the account level.
