...
- **API Gateway Integration:** [[API Gateway Overview|API Gateway]] can use Cognito User Pools as an authorizer to protect REST APIs.

> [!exam]
> When integrating [[ALB Overview|ALB]] or [[API Gateway Overview|API Gateway]] for authentication, use Cognito **User Pools**, not Identity Pools.
