...
- **Regional**: Deployed with **[[ALB Overview|ALB]]** or **[[API Gateway Overview|API Gateway]]** to protect regional resources.
...
WAF can be updated dynamically using **[[CloudWatch Logs|CloudWatch Logs]]**, **S3**, and **[[Lambda Overview|AWS Lambda]]**.
