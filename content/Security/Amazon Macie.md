...
## Key Capabilities
- **Sensitive Data Discovery**: Automates the discovery and classification of sensitive data (PII, PHI, financial data) in **Amazon S3**.
...
- **AWS Organizations Integration**: Macie provides multi-account support through AWS Organizations. A designated administrator account can manage and monitor the S3 data estate across all member accounts.
