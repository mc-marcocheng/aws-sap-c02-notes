---
tags: [aws, sap-c02, inspector, security]
---
# Amazon Inspector
...
- **Coverage:** Scans [[EC2 Overview|Amazon EC2]] instances, container images in Amazon ECR, and **[[Lambda|AWS Lambda]] functions** (including vulnerabilities in application code dependencies).
...
- **AWS Organizations:** Supports delegated administrator integration. The designated account can manage Inspector across the entire [[Organizations Overview|AWS Organizations]].
