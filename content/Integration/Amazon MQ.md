...
- **Broker Types:**
  ...
  - **Active/Standby:** High availability across two AZs using a shared Amazon [[EFS Overview|EFS]] volume (ActiveMQ) or cluster nodes (RabbitMQ).
...
---
**Practice:** [[Amazon MQ - Practice Questions|Amazon MQ Practice Questions]]