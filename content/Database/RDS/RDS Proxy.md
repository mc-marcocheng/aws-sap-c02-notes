...
> A fully managed, highly available database proxy for Amazon [[RDS Overview|RDS]] and Amazon [[Aurora Overview|Aurora]] that makes applications more scalable, more resilient to database failures, and more secure.
