...
- **Transitive Routing**: VGW does not support transitive routing (e.g., On-prem -> VGW -> Peered VPC). Use [[Transit Gateway Overview|Transit Gateway]] for transitive needs.
