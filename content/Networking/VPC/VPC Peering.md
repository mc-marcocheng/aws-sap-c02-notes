...
- **Mesh vs Hub**: As the number of VPCs grows, a full mesh of peering becomes difficult to manage. For larger scales, use [[Transit Gateway Overview|Transit Gateway]].
