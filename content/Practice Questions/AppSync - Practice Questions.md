...
> > [!success]- Answer & Rationale
> > **Answer: 2**
> > **Rationale:** AWS [[AWS WAF|WAF]] integrates directly with Amazon [[AppSync]] and can be used to set rate-based rules, block malicious IPs, and protect the backend from sudden traffic bursts or DDoS attacks.