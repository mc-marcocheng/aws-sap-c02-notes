...
> > **Answer: 2**
> > **Rationale:** [[Secrets Manager|AWS Secrets Manager]] is specifically designed to manage the lifecycle of secrets, including database credentials and API keys. It provides native support for [[KMS]] encryption and automatic rotation.
