...
> > **Answer: 2**
> > **Rationale:** [[Backup]] natively integrates with AWS Organizations for central policy management. Cross-account copies to a central vault combined with Vault Lock provides WORM protection with minimal operational overhead.
...
> > [!success]- Answer & Rationale
> > **Answer: 1**
> > **Rationale:** To perform cross-account backup copies with [[Backup]], resources must be encrypted with Customer Managed Keys (CMKs). AWS managed keys cannot be shared across accounts.
...
> > [!success]- Answer & Rationale
> > **Answer: 2**
> > **Rationale:** [[Backup]] supports lifecycle rules to automatically transition backups to cost-effective cold storage tiers and expire them after a defined retention period.