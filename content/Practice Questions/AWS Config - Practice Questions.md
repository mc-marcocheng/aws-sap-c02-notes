...
> > [!success]- Answer & Rationale
> > **Answer: 3**
> > **Rationale:** [[CloudTrail Overview|CloudTrail]] records API calls and account activity (WHO/WHEN). [[AWS Config]] provides a detailed inventory and configuration history of resources (WHAT/Current State). [[IAM Overview|IAM]] Credential Reports are used specifically for auditing user credentials, MFA status, and last login activity.
