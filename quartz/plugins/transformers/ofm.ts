            ...
            visit(tree, "blockquote", (node) => {
              ...
              if (match && match.input) {
                ...
                if (calloutContent.length > 0) {
                  // Convert soft line breaks (\n) to hard breaks (<br>) in callout
                  // content paragraphs to match Obsidian's rendering behavior
                  const processedContent = calloutContent.map((child) => {
                    if (child.type === "paragraph") {
                      ...
                      return { ...child, children: newChildren } as typeof child
                    }
                    return child
                  })
